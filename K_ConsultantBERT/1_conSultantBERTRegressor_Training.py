...
class ConsultantBERTRegressor:
    """
    Implementation of the regressor variant of ConsultantBERT (Lavi et al., 2021).
    Uses MultipleNegativesRankingLoss to optimize embeddings for cosine similarity,
    evaluated using Mean Reciprocal Rank (MRR) on ESCO job classifications.
    """
    
    def __init__(self, model_name: str = "google-bert/bert-base-multilingual-cased", max_seq_length: int = 512):
        """
        Initialize ConsultantBERTRegressor model
